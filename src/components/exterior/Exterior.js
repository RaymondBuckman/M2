        ...
        <div>
            <div className="exterior-div-1" id="Exterior">
                <div className="container">   
                    <div className="row">
                        ...
                        <a href="http://www.motortrend.com/cars/bmw/m2/2017/2017-bmw-m2-long-term-arrival-good-gets/" target="_blank" rel="noopener" role="link" aria-label="Read more about Motortrend's review">Read more...</a></p>
                    </div>
                </div>
            </div>
            <div className="exterior-div-2">
                <ul className="flex-container">
                    ...
                    data-tip data-for="spoiler">
                        M rear spoiler
                    </li>
                    <li className="flex-item scrollmagic-scale-flex-box" 
                    data-tip data-for="pipes">
                        Center-aligned Quad Exhaust Pipes
                    </li>
                    <li className="flex-item scrollmagic-scale-flex-box" 
                    data-tip data-for="gill">
                        M side gill with M2 badging
                    </li>
                    <li className="flex-item scrollmagic-scale-flex-box"
                    data-tip data-for="paint">
                        4 Paint Options (incl. Long Beach Metallic)
                    </li>
                    <li className="flex-item scrollmagic-scale-flex-box"
                    data-tip data-for="wheels">
                        Double Spoke forged alloy wheels
                    </li>
                    <li className="flex-item scrollmagic-scale-flex-box"
                    data-tip data-for="shadowline">
                        Shadowline Exterior Trim
                    </li>
                    <li className="flex-item scrollmagic-scale-flex-box"
                    data-tip data-for="bumpers">
                        M Specific front & rear bumpers
                    </li>
                    <li className="flex-item scrollmagic-scale-flex-box"
                    data-tip data-for="calipers">
                        Blue Brake Calipers
                    </li>
                    <li className="flex-item scrollmagic-scale-flex-box"
                    data-tip data-for="fenders">
